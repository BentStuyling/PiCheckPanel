...
class MainApp(tk.Tk):
    ...
    # 
    # def GetButton(self):
    #     self.Button.set(get_signal.pushbutton(self))
    #     self.TimerInterval = 500 # Update interval of this sensor value
...
adc_1 = Adafruit_ADS1x15.ADS1115(address=0x48) #change bus in case of multiple ADC's
...
class get_signal:
    ...
    def OilTemp(self):
        ...
        #self.R= 323*((Vin/self.U)-1)
        self.temp =0.6774*self.U**5 - 8.4245*self.U**4 + 40.508*self.U**3 - 91.305*self.U**2 + 118.66*self.U - 23.398
        self.value=round(self.temp)
    ...
    def ClntTemp(self):
        ...
        self.R= round((4.096/32768)*adc_1.read_adc(2, gain=1),2)
    ...
    def BatVolt(self):
        self.value = round(adc_1.read_adc(3, gain=1)*(4.069/32768)*((3.3+1)/1)*1.022, 2)
