...
class MainApp(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Labelcolor = 'white'
        global ValueFont
        ValueFont = Font(family="DS-Digital", size=28, weight = 'bold')
        global Valuecolor
        Valuecolor = 'orange'
        global UnitFont
...
class PageOne(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Label(frame_value_row_1, font = ValueFont, fg =Valuecolor,
                 bg = 'black', textvariable = self.ValPos_1).place(x = 70, y =12, anchor ='e')
        tk.Label(frame_value_row_1, font = UnitFont, fg =Unitcolor,
                 bg = 'black',text = 'C').place(x = 70, y =16, anchor ='w')
        ...
        tk.Label(frame_value_row_1, font = ValueFont, fg =Valuecolor,
                 bg = 'black', textvariable = self.ValPos_2).place(x = 190, y =12, anchor ='e')
        tk.Label(frame_value_row_1,font = UnitFont, fg =Unitcolor,
                 bg = 'black', text = 'BAR').place(x = 190, y =16, anchor ='w')        
        ...
        tk.Label(frame_value_row_2, font = ValueFont,fg =Valuecolor,
                 bg = 'black', textvariable = self.ValPos_3).place(x = 70, y =12, anchor ='e')
        ...
        tk.Label(frame_value_row_2, font = ValueFont, fg =Valuecolor,
                 bg = 'black', textvariable = self.ValPos_4).place(x = 190, y =12, anchor ='e')
        tk.Label(frame_value_row_2,font = UnitFont, fg =Unitcolor,
                 bg = 'black', text = 'V').place(x = 190, y =16, anchor ='w')        
        ...
        self.graph_duration = 180 # Time (s) of grap length

        # Parameters
        self.x_len = int(round(((self.graph_duration*1000)/self.update_interval),0)) # Number of points to display
        self.y1_range = [70, 95]  # Range of possible Y values to display left axis
        self.y2_range = [70, 95]  # Range of possible Y values to display right axis
        # Create graph fiugre
        ...
        # PLot lines
        color = 'tab:blue'
        self.line1, = self.ax1.plot(self.xs, self.ys1,linewidth=2, color=color)
        color = 'tab:orange'
        self.line2, = self.ax2.plot(self.xs, self.ys2,linewidth=2, color=color)
...
class get_signal:
    ...
    def OilPress(self):
        self.value = abs(round((((4.096/32768)*adc_1.read_adc(0, gain=1)-0.475)/4)*9,1))
    ...
    def BatVolt(self):
        ...
        self.value = '{:.2f}'.format(round(adc_1.read_adc(3, gain=1)*(4.069/32768)*((3.3+1)/1)*1.022, 2))
        return self.value  
